...
const QuestCategory: React.FC<{
	...
	return (
		<div
			className={`bg-offwhite-200 border-offwhite-50   border-solid border-2 flex flex-col  rounded-lg text-offwhite-50 ${
				active ? "" : "hidden"
			}`}
		>
			<h4 className="py-0 my-0 border-b-2 border-solid border-r-0 border-l-0 border-t-0 relative truncate pl-2 select-none text-xl">
				{category}
